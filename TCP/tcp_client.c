...
int main()
{
	...
	server_address.sin_family = AF_INET;          /* set the family of the address to know the type of address we are working with. */
        server_address.sin_port = htons(9002);       /*specify the port that we are going to connect to */
	server_address.sin_addr.s_addr = INADDR_ANY; /*to connect to a local host address 0.0.0.0 by using library fn INADDR_ANY */
